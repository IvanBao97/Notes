...
* MyISAM
  ...
  * B+ Tree 索引文件和数据文件是分离的**（非聚集索引）**
  ...
  <img src="C:\Users\yifan\AppData\Roaming\Typora\typora-user-images\image-20201015230437519.png" alt="image-20201015230437519" style="zoom:50%;" />
...
* InnoBD
  ...
  * 叶节点包含了完整的数据记录
  ...
  <img src="C:\Users\yifan\AppData\Roaming\Typora\typora-user-images\image-20201015230408961.png" alt="image-20201015230408961" style="zoom:50%;" />
